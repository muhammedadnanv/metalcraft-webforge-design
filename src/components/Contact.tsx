          ...
          <div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="p-2 sm:p-3 bg-accent-orange/20 rounded-full text-accent-orange">
                  <Phone size={isMobile ? 18 : 24} />
                </div>
                <div>
                  <h3 className="font-bold text-lg sm:text-xl">Call Us</h3>
                  <p className="text-white/80 text-xs sm:text-sm">Mobile Numbers:</p>
                  <p className="text-white/80 text-xs sm:text-sm">+971 554610350</p>
                  <p className="text-white/80 text-xs sm:text-sm">+971 506771566</p>
                  <p className="text-white/80 text-xs sm:text-sm">+971 508937800</p>
                  <p className="text-white/80 text-xs sm:text-sm">Landline: +971 6 565 1865</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg sm:text-xl">Email Us</h3>
                  <p className="text-white/80 text-xs sm:text-sm">jawadmetals@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg sm:text-xl">Visit Our Workshop</h3>
                  <p className="text-white/80 text-xs sm:text-sm">Address, Ajman 100011, Al Ajman, United Arab Emirates</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-white/5 rounded-lg">
              <h3 className="font-bold text-lg sm:text-xl mb-3 sm:mb-4">Business Hours</h3>
          ...
          <div>
            <div className="bg-white/10 backdrop-blur-sm p-4 sm:p-6 md:p-8 rounded-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-white/5 border-white/10 text-white text-base"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label htmlFor="message" className="block text-xs sm:text-sm font-medium mb-1">Project Details</label>
                  <Textarea
                    id="message"
                    name="message"

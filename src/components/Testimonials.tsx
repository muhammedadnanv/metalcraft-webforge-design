  ...
  return (
    <section id="testimonials" className="section-padding bg-gray-50">
      <div className="container mx-auto">
        <div className="text-center mb-8 sm:mb-12 reveal-animation">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
            What Our <span className="text-accent-orange">Clients Say</span>
          </h2>
          <p className="text-matte-black/70 max-w-2xl mx-auto px-4 sm:px-0 text-sm sm:text-base">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 px-4 sm:px-0">

            ...
            <div className="bg-metal-silver/10 backdrop-blur-sm rounded-lg p-4 sm:p-6 md:p-8 border border-metal-silver/30 shadow-xl">
              ...
              <div className="mt-6 grid grid-cols-3 gap-2 sm:gap-4">
                <div className="text-center">
                  <div className="font-bold text-xl sm:text-2xl text-steel-blue">15+</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Years Experience</div>
                </div>
                <div className="text-center">
                  <div className="font-bold text-xl sm:text-2xl text-steel-blue">500+</div>
                  <div className="text-xs sm:text-sm text-muted-foreground">Projects Completed</div>
                </div>
                <div className="text-center">
                  <div className="font-bold text-xl sm:text-2xl text-steel-blue">100%</div>
